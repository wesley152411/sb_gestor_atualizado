...
import {
  ...
  Settings, LifeBuoy, ShoppingBag, Store, MessageSquare, CalendarDays, Menu, ExternalLink,
} from 'lucide-react';
    ...
    <aside className={cn('sidebar-v2', collapsed && 'collapsed')}>
      ...
      <div className="sidebar-v2-bottom">
        <div className="sidebar-v2-bottom-links">
          <a href="#" className="sidebar-v2-bottom-link" aria-label="Suporte" title={collapsed ? 'Suporte' : undefined}>
